// All content below has been created or edited with the help of GenAI.
// OpenAI. (2024). ChatGPT (November 2024 version) [Large language model]. https://chat.openai.com/
// Anthropic. (2024). Claude AI. Anthropic. https://www.anthropic.com/claude

// Constants for API interaction
// Created with the help of Worthy, P. (2024). API documentation Generic Event [Instructional manual]. University of Queensland.
...
// Referenced from ByteGrad . (2023, February 24). Responsive Navbar With Animated Hamburger Menu (HTML, CSS & JS)  [Video]. YouTube. https://www.youtube.com/watch?v=YIVXOMvXmNE
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Popup Window for each image of slideshow on Home page
      ...
      switch (index) {
        case 0:
          eventInfo = {
            title: "Carnival",
            description:
              "Enjoy the festivities of Carnival with parades, music, and dance! Visit our site to book now!",
        ...
        case 1:
          eventInfo = {
            title: "DJ Night",
            description:
              "Dance the night away with our amazing DJs spinning the best tracks. Book your tickets now!",
            host: "XYZ Club",
            date: "March 5, 2025",
          };
          break;
        case 2:
          eventInfo = {
            ...
            description:
              "Join us for a day of live music from various artists. Head to our site to reserve your seats.",
            host: "BrazilFests",
            date: "April 15, 2025",
          };
          break;
        case 3:
          eventInfo = {
            title: "Night Club",
            description:
              "Experience the vibrant nightlife at our top-rated night club. Tickets on sale now!",
            host: "Nightlife Rio",
            date: "May 20, 2025",
          };
          break;
...
// Popup Window for slideshow images on events page
document.addEventListener("DOMContentLoaded", function () {
...
// Popup Window for items in Insights and Recommendations page
document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const notificationsPopup = document.getElementById(
    "communityNotificationsPopup"
  );
  const closePopup = document.getElementById(
    "closeCommunityNotificationsPopup"
  );
...
// W3Schools. (n.d.). How to create a search bar. W3Schools. https://www.w3schools.com/howto/howto_css_searchbar.asp
document.addEventListener("DOMContentLoaded", () => {
...
document
  ...
  .addEventListener("keypress", function (event) {
    if (event.key === "Enter") {
      ...
      window.location.href = `community.html?search=${encodeURIComponent(
        query
      )}`;
    }
  });
